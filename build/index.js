...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoHeader = __webpack_require__(160);

	var _TodoHeader2 = _interopRequireDefault(_TodoHeader);

	var _localDb = __webpack_require__(161);

	var _localDb2 = _interopRequireDefault(_localDb);

	var _TodoAddText = __webpack_require__(162);

	var _TodoAddText2 = _interopRequireDefault(_TodoAddText);

	var _TodoMain = __webpack_require__(163);

	var _TodoMain2 = _interopRequireDefault(_TodoMain);

	var _TodoFooter = __webpack_require__(165);
	...
	var Todo = function (_React$Component) {
	   ...
	   function Todo(props) {
	      ...
	      _this.todoDb = new _localDb2.default("Todo"); //利用localDB半持久化数据
	      _this.state = { todo: '', todoValue: '', todos: _this.todoDb.get('todos') || [] };
	   ...
	   _createClass(Todo, [{
	      ...
	      key: 'changeIsDone',
	      value: function changeIsDone(index, isDone) {
	         var todoItem = this.state.todos[index];
	      ...
	      value: function render() {
	         ...
	         var count = {
	            ...
	            doneNum: this.state.todos.filter(function (todo) {
	               return todo.isDone;
	            }).length || 0
	         };
	         ...
	         return _react2.default.createElement(
	            ...
	            _react2.default.createElement(_TodoAddText2.default, { addTodo: this.addTodo.bind(this) }),
	            _react2.default.createElement(_TodoMain2.default, { todos: this.state.todos, delTodo: this.delTodo.bind(this), changeIsDone: this.changeIsDone.bind(this) }),
	            _react2.default.createElement(_TodoFooter2.default, count)
	         );
	      }
	   }]);
	   ...
	   _createClass(TodoHeader, [{
	      ...
	      value: function render() {
	         return _react2.default.createElement(
	            "div",
	            { className: "todoHeader" },
	            _react2.default.createElement("input", { ref: "todoValue", onKeyUp: this.handleKeyUp.bind(this), className: "todoTaskContent", type: "text", name: "todo", placeholder: "请输入你下一步要做的事儿", onChange: this.changeTodo.bind(this) }),
	            _react2.default.createElement(
	               "button",
	               { onClick: this.addText.bind(this), className: "addBtn" },
	               "Add"
	            )
	         );
	      }
	      ...
	      value: function addText() {
	         ...
	         _react2.default.findDOMNode(this.refs.todoValue).value = '';
	      }
	   }, {
	      key: "changeTodo",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoItem = __webpack_require__(164);
	...
	var TodoMain = function (_React$Component) {
	   ...
	   function TodoMain(props) {
	      ...
	      return _possibleConstructorReturn(this, (TodoMain.__proto__ || Object.getPrototypeOf(TodoMain)).call(this, props));
	   }
	      ...
	      value: function render() {
	         ...
	         return _react2.default.createElement(
	            ...
	            this.props.todos.map(function (todo, index) {
	               return _react2.default.createElement(_TodoItem2.default, _extends({ text: todo.text, isDone: todo.isDone, index: index }, _this2.props));
	            })
	         );
	      }
	   }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoItem = function (_React$Component) {
	   ...
	   _createClass(TodoItem, [{
	      ...
	      value: function render() {
	         //已完成中划线
	         var doneStyle = this.props.isDone ? { textDecoration: 'line-through', color: 'navajowhite' } : { textDecoration: 'none' };
	         ...
	         return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	               'button',
	               { className: 'del', ref: 'deleteBtn', onClick: this.handleDelete.bind(this) },
	               '删除'
	            )
	         );
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoFooter = function (_React$Component) {
	   ...
	   function TodoFooter(props) {
	      ...
	      return _possibleConstructorReturn(this, (TodoFooter.__proto__ || Object.getPrototypeOf(TodoFooter)).call(this, props));
	   }
